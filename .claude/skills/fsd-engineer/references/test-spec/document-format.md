...
The human-readable document the canonical specs (`../test-spec-schema.md`) are rendered into: section order, preamble, step tables, and pass criteria. Absorbed from the former `create-test-spec` skill.
