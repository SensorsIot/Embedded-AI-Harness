...
- **Extract pure cores** — separate the decision from the I/O. A size check, a
  ...
  reach it.
- **Verification before commit** — see `../project/conventions.md` for the
  commands and for the honest current state of lint and typing.
...
- **Commits** — see `../project/conventions.md`. Never commit generated output,
  build artifacts, temporary directories, or secrets.
